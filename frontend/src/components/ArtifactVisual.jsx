    ...
    <div className="artifact-card artifact-card-visual">
      <div className="superior-section">
        <div className="text-gray-custom text-md m-0 p-0">
          <h2 className="text-lg text-spectral text-white-custom m-0 p-0">
            {artifact.name}
          </h2>
        ...
        {artifact.image && (
          <img src={artifact.image} alt={artifact.name} className="artifact-image-card" />
        )}
      </div>
